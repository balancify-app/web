    ...
    <Card className="overflow-hidden shadow-none">
      ...
      <CardContent className="flex flex-col gap-2 p-4">
        <div className="flex items-center justify-between">
          <div className="h-3 w-16 animate-pulse rounded-lg bg-muted-foreground/15" />
          <div className="h-3 w-20 animate-pulse rounded-lg bg-muted-foreground/15" />
        </div>
        <div className="flex items-center justify-between">
          <div className="h-3 w-16 animate-pulse rounded-lg bg-muted-foreground/15" />
        ...
        <div className="flex items-center justify-between">
          <div className="h-3 w-16 animate-pulse rounded-lg bg-muted-foreground/15" />
          <div className="h-6 w-14 animate-pulse rounded-lg bg-muted-foreground/15" />
        </div>
      </CardContent>
    </Card>
  )
